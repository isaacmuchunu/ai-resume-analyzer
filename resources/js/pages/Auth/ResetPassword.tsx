                        ...
                        <CardContent>
                            ...
                            <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800/30 rounded-lg">
                                ...
                                <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
                                    <li className={`flex items-center space-x-2 ${data.password.length >= 8 ? 'text-green-600' : ''}`}>
                                        <CheckCircle className={`h-3 w-3 ${data.password.length >= 8 ? 'text-green-600' : 'text-gray-400'}`} />
                                        <span>At least 8 characters</span>
                                    </li>
                                    <li className={`flex items-center space-x-2 ${/[A-Z]/.test(data.password) ? 'text-green-600' : ''}`}>
                                        <CheckCircle className={`h-3 w-3 ${/[A-Z]/.test(data.password) ? 'text-green-600' : 'text-gray-400'}`} />
                                    ...
                                    <li className={`flex items-center space-x-2 ${/\d/.test(data.password) ? 'text-green-600' : ''}`}>
                                        <CheckCircle className={`h-3 w-3 ${/\d/.test(data.password) ? 'text-green-600' : 'text-gray-400'}`} />
                                        <span>One number</span>
                                    </li>
                                    <li className={`flex items-center space-x-2 ${/[^A-Za-z\d]/.test(data.password) ? 'text-green-600' : ''}`}>
                                        <CheckCircle className={`h-3 w-3 ${/[^A-Za-z\d]/.test(data.password) ? 'text-green-600' : 'text-gray-400'}`} />
